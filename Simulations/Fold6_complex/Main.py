...
import tracemalloc  # Import tracemalloc for more granular memory profiling

# Load the dataset
df1 = pd.read_csv('Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df2 = pd.read_csv('Friday-WorkingHours-Afternoon-PortScan.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df3 = pd.read_csv('Friday-WorkingHours-Morning.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df4 = pd.read_csv('Monday-WorkingHours.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df5 = pd.read_csv('Thursday-WorkingHours-Afternoon-Infilteration.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df6 = pd.read_csv('Thursday-WorkingHours-Morning-WebAttacks.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df7 = pd.read_csv('Tuesday-WorkingHours.pcap_ISCX.csv', encoding='latin1', low_memory=False)
df8 = pd.read_csv('Wednesday-workingHours.pcap_ISCX.csv', encoding='latin1', low_memory=False)
...
list_version = X_test.tolist()

with open('X_test.json', 'w') as f:
    json.dump(list_version, f)

X_subsample = X_test[:10]
list_version_sub = X_subsample.tolist()
with open('X_test_subsample.json', 'w') as f:
    json.dump(list_version_sub, f)
